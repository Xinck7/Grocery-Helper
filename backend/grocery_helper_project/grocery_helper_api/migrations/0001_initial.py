# Generated by Django 3.2.16 on 2023-01-08 05:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ailse', models.DecimalField(blank=True, decimal_places=0, help_text='where it is in the store approximately', max_digits=10)),
                ('amount', models.DecimalField(decimal_places=0, default=1, help_text='how many do you want? - needs a number', max_digits=10)),
                ('calore_per_serving', models.DecimalField(blank=True, decimal_places=2, help_text='calorie number eg 500', max_digits=10)),
                ...
                ('price', models.DecimalField(blank=True, decimal_places=2, help_text='how much in USD? eg 3', max_digits=10)),
                ...
                ('added_by', models.CharField(default='root', help_text='Added by person', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(blank=True, decimal_places=2, help_text='how much in USD? eg 3', max_digits=10)),
                ('time_to_cook', models.DecimalField(blank=True, decimal_places=1, default=0, help_text='how long to make it start to finish?', max_digits=3)),
                ('added_by', models.CharField(default='root', help_text='Added by person', max_length=100)),
                ('show_only_your_added_by', models.BooleanField(default=False, help_text='Show only your stuff or look at the catalog')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('price', models.DecimalField(blank=True, decimal_places=2, default=0, help_text='total price of items and ingredients', max_digits=10)),
                ('owner', models.CharField(default='root', help_text='Whose list is it anyways?', max_length=100)),
                ('added_by', models.CharField(default='root', help_text='Added by person', max_length=100)),
                ('show_only_your_added_by', models.BooleanField(default=False, help_text='Show only your stuff or look at the catalog')),
                ('ingredients', models.ManyToManyField(to='grocery_helper_api.Ingredient')),
